function [twix_obj,mdh] = mapVBVD2014(filename,varargin)
...
%%%%% Parse varargin %%%%%
    ...
    for s=1:NScans
        if version  == 'vd';
            [twix_obj{s}.hdr] = read_twix_hdr(fid);
        end
        % declare data objects:
        twix_obj{s}.image      = twix_map_obj_2014(arg,'image',filename,version);
        twix_obj{s}.noise      = twix_map_obj_2014(arg,'noise',filename,version);
        twix_obj{s}.phasecor   = twix_map_obj_2014(arg,'phasecor',filename,version);
        twix_obj{s}.refscan    = twix_map_obj_2014(arg,'refscan',filename,version);
        twix_obj{s}.refscanPC  = twix_map_obj_2014(arg,'refscan_phasecor',filename,version);
        twix_obj{s}.RTfeedback = twix_map_obj_2014(arg,'rtfeedback',filename,version);    
        twix_obj{s}.phasestab  = twix_map_obj_2014(arg,'phasestab',filename,version);
    ...
    mdh.ushKSpaceCentreColumn=mdh.ushKSpaceCentreColumn+1;
    mdh.ushKSpaceCentrePartitionNo=mdh.ushKSpaceCentrePartitionNo+1;
    mdh.version=version;
    elapsed_time = toc;
